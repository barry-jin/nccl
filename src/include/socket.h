...
#define RETRY_REFUSED_TIMES   2e5 // connection refused retry times before reporting a timeout (200 sec)
#define RETRY_ABORTED_TIMES   2e5 // connection aborted retry times before reporting a timeout (200 sec)
